...
from cv_pipeline.modules.unet_segmenter import UNetSegmenter  # noqa: E402, E501, I001
...
UNET_WEIGHTS = os.path.join(
    ROOT_DIR, "model_training",
    "image_segmentation", "weights", "maze_floor_segmenter_unet_v1.pth")
...
def main():
    ...
    detector = TargetDetector(YOLO_WEIGHTS, grid_size=GRID_RESOLUTION)
    segmenter = UNetSegmenter(UNET_WEIGHTS, grid_size=GRID_RESOLUTION)
